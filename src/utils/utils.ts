...
//use of stream 
const chargeTemplatesStream = ChargeTemplateModel.find(finalQuery).lean().cursor();

const chargeTemplates: any[] = [];
for await(const chargeTemplate of chargeTemplatesStream){
  chargeTemplates.push(chargeTemplate);
}
